...
class YachtBookingDetail extends StatefulWidget {
  const YachtBookingDetail({super.key});

  @override
  State createState() => _YachtBookingDetail();
}

class _YachtBookingDetail extends State<YachtBookingDetail> {
