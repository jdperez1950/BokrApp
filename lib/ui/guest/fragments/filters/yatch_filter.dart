...
class FilterYachtWidget extends StatefulWidget {
  const FilterYachtWidget({Key? key}) : super(key: key);

  @override
  _FilterYachtWidgetState createState() => _FilterYachtWidgetState();
}

class _FilterYachtWidgetState extends State<FilterYachtWidget> {
