        ...
        Padding(
            ...
            child: Column(
              children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text('Insurance Card'),
                                      Text(
                                          'The insurance must mathc the drivers information',
                                          style: TextStyle(fontSize: 10))
                                    ],
                                  ),
                                ],
                ...
                Align(
                  child: Text(
                    'By uploading these documents you allow the Host to run verifications such driving records, background checks and contact your insurance company to get information about your policy.',
                    style: TextStyle(fontSize: 10),
                  ),
                ),
                Divider(
